...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className={`${showBar ? 'hidden' : 'flex'} md:flex flex-col md:flex-row md:items-center fixed md:sticky h-screen md:h-14 w-2/5 md:w-full md:justify-between bg-gradient-to-t from-slate-800/[90%] to-black top-0 z-10 transition-all duration-250`}>
